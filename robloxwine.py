...
WINE_VERSIONS = {
    ...
    "7.20.r1.gbd2608b1": {
        "url": "https://cdn.discordapp.com/attachments/858117357897121822/1038216311198715934/debuntu-wine-tkg-staging-fsync-git-7.20.r1.gbd2608b1.7z",
        "hash": {
            "type": "sha512",
            "value": "c992cf277feae8a64969371c6c46d3e15a742791ba100092f6deec2e7048c322b9f1bc0f807421659d4f50591bd70b84e5521b9f61c47842bcb63b06edb6d80f"
        }
    }
}
...
def update_grapejuice_settings(wine_binary_path: str):
    ...
    settings_version = next(
        filter(
            None,
            [
                data.get("__version__", None),
